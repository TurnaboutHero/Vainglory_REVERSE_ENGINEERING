...
class TestKdaDetectorTailFiltering(unittest.TestCase):
    def test_default_buffers_exclude_late_kills_but_keep_short_tail_deaths(self) -> None:
        ...
        self.assertEqual(results[1].kills, 1)
        self.assertEqual(results[2].assists, 1)
